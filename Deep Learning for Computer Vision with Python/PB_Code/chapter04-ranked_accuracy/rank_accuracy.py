...
# python rank_accuracy.py --db ../datasets/covid19-dataset/hdf5/extracted_features.hdf5 --model covid19.cpickle

# import the necessary packages
from deeplearning.utils.ranked import rank5_accuracy
import argparse
import pickle
import h5py
