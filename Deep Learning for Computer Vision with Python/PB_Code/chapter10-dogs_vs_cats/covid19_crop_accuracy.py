# USAGE
# python covid19_crop_accuracy.py

# import the necessary packages
from config import alexnet_covid19_config as config
...
testGen = HDF5DatasetGenerator(config.TEST_HDF5, 128,
	preprocessors=[sp, mp, iap], classes=2)
predictions = model.predict_generator(testGen.generator(),
	steps=testGen.numImages // 4, max_queue_size=64 * 2)
...
pbar = progressbar.ProgressBar(maxval=testGen.numImages // 4,
