...
TRAIN_IMAGES = "../datasets/covid19-dataset/training/"
VAL_IMAGES = "../datasets/covid19-dataset/validation/images"
'''
...
DATASET_MEAN = "output/covid19-dataset-200-mean.json"
