# USAGE
# python train_alexnet_covid19.py
...
opt = Adam(lr=1e-3)
model = AlexNet.build(width=256, height=256, depth=3,
...
model.fit_generator(
	trainGen.generator(),
	steps_per_epoch=trainGen.numImages // 4,
	validation_data=valGen.generator(),
	validation_steps=valGen.numImages // 4,
	epochs=75,
